...
import tarif_pdf from './public/assets/tarif_2025-2026.pdf';
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="relative">
            <div className="relative w-full h-[500px] overflow-hidden rounded-lg">
              <div
                className={`absolute w-full h-full transition-opacity duration-500 ease-in-out ${isTransitioning ? "opacity-0" : "opacity-100"
                  }`}
              >
                <img
